        ...
        <div className="w-full bg-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-4">
              ...
              >
                ...
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-center gap-3">
                    ...
                    <div className="font-normal text-gray-600 text-[15px]">
                      {item.text}
                    </div>
                  </div>
                ))}
              ...
              >
                <h3 className="font-semibold text-xl text-gray-1 mb-2">
                  Заказать подбор доски
                </h3>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <Checkbox
                    id="terms"
                    className="w-4 h-4 rounded-sm data-[state=checked]:bg-blue-4 border-gray-300"
                  />
                  <label
                    htmlFor="terms"
                  ...
                  >
                    ...
                    <span className="text-blue-4 underline cursor-pointer">
                      персональных данных
                    </span>
                  </label>
                </div>
