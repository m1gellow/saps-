        ...
        <div className="flex border-b">
          <button
            className={`px-6 py-3 text-sm font-medium ${
              activeTab === 'all' ? 'text-blue-4 border-b-2 border-blue-4' : 'text-gray-600 hover:text-blue-4'
            }`}
          ...
          <button
            className={`px-6 py-3 text-sm font-medium ${
              activeTab === 'differences' ? 'text-blue-4 border-b-2 border-blue-4' : 'text-gray-600 hover:text-blue-4'
            }`}
