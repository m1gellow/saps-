              ...
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-md flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    Для настройки интеграции с платежными системами (Stripe, PayPal и др.)
                    обратитесь к документации или в техническую поддержку.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-4 bg-gray-50 rounded-md border border-gray-200 space-y-4">
                <div className="flex items-center">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('enableOrderNotifications', !!checked)
                    }
                    className="h-4 w-4 border-gray-300 rounded"
                  />
                ...
                <div className="flex items-center">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('enableLowStockNotifications', !!checked)
                    }
                    className="h-4 w-4 border-gray-300 rounded"
                  />
                ...
                <div className="flex items-center">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('enableCustomerNotifications', !!checked)
                    }
                    className="h-4 w-4 border-gray-300 rounded"
                  />
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-red-50 border border-red-200 rounded-md mt-6">
                ...
                <p className="text-sm text-red-700 mb-4">
                  Эти действия могут привести к серьезным последствиям для вашего магазина.
